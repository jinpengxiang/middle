 ...
 */
package com.banana.middle.txlcn.tm.core.storage.redis;

import com.banana.middle.txlcn.tm.core.storage.LockValue;
import com.banana.middle.txlcn.tm.core.storage.TransactionUnit;
import com.txlcn.common.exception.FastStorageException;
import com.txlcn.common.lock.DTXLocks;
import com.txlcn.common.util.ApplicationInformation;
import com.banana.middle.txlcn.tm.cluster.TMProperties;
import com.banana.middle.txlcn.tm.config.TxManagerConfig;
import com.banana.middle.txlcn.tm.core.storage.FastStorage;
...
public class RedisStorage implements FastStorage {
    ...
    private static final String REDIS_GROUP_PREFIX = "banana_tm:group:";

    private static final String REDIS_GROUP_STATE = REDIS_GROUP_PREFIX + "banana_transactionState:";

    private static final String REDIS_TOKEN_PREFIX = "banana_tm.token";

    private static final String REDIS_TM_LIST = "banana_tm.instances";

    private static final String REDIS_MACHINE_ID_MAP_PREFIX = "banana_tm.machine.id.gen:";
